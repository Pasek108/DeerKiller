...
class Enemy {
  ...
  move(ctx) {
    ...
    if (this.explosion_frame < 14) {
      ctx.drawImage(this.explosion, this.x + 6 * (12 - this.explosion_frame) - 10 * this.explosion_frame - 40, this.y + 6 * (12 - this.explosion_frame) - 10 * this.explosion_frame - 40, this.explosion_width * (this.explosion_frame / 6), this.explosion_height * (this.explosion_frame / 6))
    }
