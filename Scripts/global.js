...
/* ---------- images ---------- */
const player_img = loadImage("Images/Game/player.png")
const enemy_img = loadImage("Images/Game/enemy.png")
const blood_img = loadImage("Images/Game/blood.png")
const deer_img = {
...
const explosion_img = []
for (let i = 0; i <= 13; i++) {
  const explosion_frame = loadImage(`Images/Game/Explosion/${i}.png`)
